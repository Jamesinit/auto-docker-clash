...
# Don't need to change if you wille use the default docker-compose-subconverter.yml
...
def change_clash_contrl_args():
    ...
    Just for clash
    '''
    with open(config_dir + "clash.yaml", mode='r', encoding="utf-8") as f:
        lines = f.readlines()
    ...
    with open(config_dir + "clash.yaml", mode='w', encoding="utf-8") as f:
        f.writelines(lines)
